...
class SignUpViewController: UIViewController {
    ...
    private func addConstraints() {
        ...
        usernameTextField.widthAnchor.constraint(equalTo: contentView.widthAnchor, constant: -40).isActive = true
        usernameTextField.heightAnchor.constraint(equalToConstant: 50).isActive = true
        
        // FirstNameTextField
        firstNameTextField.topAnchor.constraint(equalTo: usernameTextField.bottomAnchor, constant: 20).isActive = true
        firstNameTextField.centerXAnchor.constraint(equalTo: contentView.centerXAnchor).isActive = true
        firstNameTextField.widthAnchor.constraint(equalTo: contentView.widthAnchor, constant: -40).isActive = true
        ...
        lastNameTextField.widthAnchor.constraint(equalTo: contentView.widthAnchor, constant: -40).isActive = true
